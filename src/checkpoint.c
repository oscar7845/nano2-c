...
int save_checkpoint(const char* dir,const struct Model* M,const struct Config* cfg,int step,float val_loss,int is_best){
    ...
    // meta building partially cleaned
    char meta[2048];
