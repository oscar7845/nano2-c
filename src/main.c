//selection of MPI+CUDA device, load config and data,
//run single fw pass and print mean loss and time taken.
//i assume inputs are ok
//TODO:
...
int main(int argc, char** argv){
    ...
    //selection CUDA device (one GPU per local rank)
